#!/usr/bin/env python3
"""
CPU accuracy test for sparse_attention_antiquant.
...
X86_SRC = os.path.join(ROOT, "sparse_attention_antiquant_x86.c")
ARM_SRC = os.path.join(ROOT, "output_arm64", "sparse_attention_antiquant_demo", "sparse_attention_antiquant_demo.c")
...
def main():
    ...
    if is_arm:
        ...
        func_name = "sparse_attention_antiquant_demo"
    else:
        so_path = compile_shared_lib(X86_SRC)
        func_name = "sparse_attention_antiquant_x86"
