/**
 * x86 demo for sparse_flash_attention_quant (simplified attention core).
 */
...
void sparse_flash_attention_quant_x86(const float* q, const float* k, const float* v, float* out) {
    float k_t[D][TK] = {0};
...
int main(void) {
    ...
    sparse_flash_attention_quant_x86(q, k, v, out);
