...
static float _tile_attention_output_tile_256_weights[32768];
static float _tile_attention_output_tile_256_v[16384];
static float _tile_attention_output_tile_256_result[32768];

int64_t attention_output_tile_256_sim(float* input_weights, float* input_v, float* output) {
    int64_t _cycle_count = 0;


    _cycle_count += (int64_t)(32768 * CYCLE_TLOAD_PER_ELEMENT);  // TLOAD weights
    _cycle_count += (int64_t)(16384 * CYCLE_TLOAD_PER_ELEMENT);  // TLOAD v
...
void attention_output_tile_256(void** args, int32_t num_args) {
...
int64_t attention_output_tile_256_cycle_count(void** args, int32_t num_args) {
    (void)num_args;
    float* input_weights = (float*)args[0];
    float* input_v = (float*)args[1];
    float* output = (float*)args[2];
    return attention_output_tile_256_sim(input_weights, input_v, output);
}