...
int64_t rowexpanddiv_sim(float* input_x, float* input_row, float* output) {
...
void rowexpanddiv(void** args, int32_t num_args) {
...
int64_t rowexpanddiv_cycle_count(void** args, int32_t num_args) {
    (void)num_args;
    float* input_x = (float*)args[0];
    float* input_row = (float*)args[1];
    float* output = (float*)args[2];
    return rowexpanddiv_sim(input_x, input_row, output);
}