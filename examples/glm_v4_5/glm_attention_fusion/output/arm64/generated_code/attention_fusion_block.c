...
int main(int argc, char** argv) {
    ...
    // Allocate test data
    float* input_q = (float*)calloc(1024 * 1024, sizeof(float));
    float* input_k = (float*)calloc(1024 * 1024, sizeof(float));
    float* input_v = (float*)calloc(1024 * 1024, sizeof(float));
    float* output_o = (float*)calloc(1024 * 1024, sizeof(float));
    float* state_o = (float*)calloc(1024 * 1024, sizeof(float));
    float* state_l = (float*)calloc(1024 * 1024, sizeof(float));
    float* state_m = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_s = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_s_scaled = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_m_new = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_m_local = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_s_shifted = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_p = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_l_local = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_m_diff = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_scale = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_l_scaled = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_o_scaled = (float*)calloc(1024 * 1024, sizeof(float));
    float* temp_o_local = (float*)calloc(1024 * 1024, sizeof(float));
    ...
    if (benchmark_only) {
        ...
        attention_fusion_block(rt, input_q, input_k, input_v, output_o, state_o, state_l, state_m, temp_s, temp_s_scaled, temp_m_new, temp_m_local, temp_s_shifted, temp_p, temp_l_local, temp_m_diff, temp_scale, temp_l_scaled, temp_o_scaled, temp_o_local);
        ...
        printf("Running orchestration function: attention_fusion_block\n");
        printf("------------------------------------------------------------\n");
