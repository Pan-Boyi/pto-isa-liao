// PTO Program: rowexpandmul
// Function Type: InCore (tile-level computation)
// ======================================================================
// TILE BUFFER ANALYSIS: rowexpandmul
// ======================================================================
//
// SUMMARY:
//   Total tiles declared:     3
//   Total capacity (no reuse): 8,224 bytes (8.0 KB)
//   Total capacity (w/ reuse): 8,224 bytes (8.0 KB)
...
void rowexpandmul(float* input_x, float* input_row, float* output) {
    float x[8][128];
    float row_vals[8][1];
    float result[8][128];
    ...
    // TROWEXPANDMUL: result = x * broadcast(row_vals)
    for (int _row = 0; _row < 8; _row++) {
