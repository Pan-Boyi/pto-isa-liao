...
void attention_score_tile_128(float* input_q, float* input_kt, float* output) {
    float q[128][128];
    float k_t[128][128];
    float scores[128][128];
    float scaled_scores[128][128];
...
#include <stddef.h>
const char* pto_program_name() { return "attention_score_tile_128"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    attention_score_tile_128((float*)args[0], (float*)args[1], (float*)args[2]);
}
