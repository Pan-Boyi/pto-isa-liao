...
// ======================================================================
// TILE BUFFER ANALYSIS: linear_tile_128
// ======================================================================
//
// SUMMARY:
...
void linear_tile_128(float* input, float* weight, float* output) {
    float x[128][128];
    float w[128][128];
    ...
    // FUSED LOOP (2 ops): x=TLOAD(input,0,0); w=TLOAD(weight,0,0)
...
#include <stddef.h>
const char* pto_program_name() { return "linear_tile_128"; }
...
void pto_launch(void **args, void *stream) {
    (void)stream;
    linear_tile_128((float*)args[0], (float*)args[1], (float*)args[2]);
}
