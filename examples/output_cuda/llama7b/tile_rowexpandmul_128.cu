...
// ======================================================================
// TILE BUFFER ANALYSIS: tile_rowexpandmul_128
// ======================================================================
//
// SUMMARY:
...
__device__ float row_vals[128][1];
__device__ float result[128][128];

__global__ void tile_rowexpandmul_128_kernel(float* input_x, float* input_row, float* output) {
...
void tile_rowexpandmul_128(float* input_x, float* input_row, float* output) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
    tile_rowexpandmul_128_kernel<<<grid, block>>>(input_x, input_row, output);
