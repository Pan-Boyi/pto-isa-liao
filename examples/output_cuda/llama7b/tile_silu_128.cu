...
//   --------------------------------------------------------------------------------
//   exp_neg_x            128x128    f32     65536   [  2,   3]           -
//   neg_x                128x128    f32     65536   [  1,   2]           -
//   one_plus_exp         128x128    f32     65536   [  3,   4]           <- neg_x
//   result               128x128    f32     65536   [  5,   6]           <- one_plus_exp
//   sigmoid              128x128    f32     65536   [  4,   5]           <- exp_neg_x
//   x                    128x128    f32     65536   [  0,   5]           -
//
// BUFFER REUSE MAP:
...
__device__ float neg_x[128][128];
__device__ float exp_neg_x[128][128];
__device__ float one_plus_exp[128][128];
__device__ float sigmoid[128][128];
__device__ float result[128][128];

__global__ void tile_silu_128_kernel(float* input, float* output) {
...
void tile_silu_128(float* input, float* output) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
    tile_silu_128_kernel<<<grid, block>>>(input, output);
