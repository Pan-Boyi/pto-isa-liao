...
// ======================================================================
// TILE BUFFER ANALYSIS: tile_rsqrt_128
// ======================================================================
//
// SUMMARY:
...
__global__ void tile_rsqrt_128_kernel(float* input, float* output) {
...
void tile_rsqrt_128(float* input, float* output) {
    dim3 block(8, 8);
    dim3 grid(1, 1);
    tile_rsqrt_128_kernel<<<grid, block>>>(input, output);
